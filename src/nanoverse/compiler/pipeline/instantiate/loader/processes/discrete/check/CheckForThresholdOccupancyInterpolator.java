 ...
 */
public class CheckForThresholdOccupancyInterpolator extends DiscreteProcessInterpolator {

    private final CheckForThresholdOccupancyDefaults defaults;

    public CheckForThresholdOccupancyInterpolator() {
        super();
        defaults = new CheckForThresholdOccupancyDefaults();
    }
