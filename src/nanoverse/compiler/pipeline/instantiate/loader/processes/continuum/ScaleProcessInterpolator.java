 ...
 */
public class ScaleProcessInterpolator extends ProcessInterpolator {
    public ScaleProcessInterpolator() {
        super();
    }

    public ScaleProcessInterpolator(LoadHelper load, BaseProcessArgumentsLoader bpaLoader) {
