 ...
 */
public class ApplyRelationshipsInterpolator extends ProcessInterpolator {

    public ApplyRelationshipsInterpolator() {
        super();
    }

    public ApplyRelationshipsInterpolator(LoadHelper load, BaseProcessArgumentsLoader bpaLoader) {
