...
public class VisualizationSerializerFactoryHelper {

    public VisualizationSerializer build(GeneralParameters p, Visualization visualization, String prefix, LayerManager lm) {
