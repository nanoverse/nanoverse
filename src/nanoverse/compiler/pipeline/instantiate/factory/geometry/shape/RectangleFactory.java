...
public class RectangleFactory implements Factory<Rectangle> {
    ...
    private final RectangleFactoryHelper helper;
    ...
    public RectangleFactory() {
        helper = new RectangleFactoryHelper();
    }

    public RectangleFactory(RectangleFactoryHelper helper) {
        this.helper = helper;
    }
    ...
    public Rectangle build() {
        return helper.build(lattice, width, height);
    }
}