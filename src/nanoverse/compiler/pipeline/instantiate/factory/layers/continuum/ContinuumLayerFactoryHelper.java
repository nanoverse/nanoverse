...
public class ContinuumLayerFactoryHelper {
    ...
    public ContinuumLayer build(ContinuumLayerScheduler scheduler, ContinuumLayerContent content, Geometry geometry) {
        return new ContinuumLayer(scheduler, content, geometry);
    }
}