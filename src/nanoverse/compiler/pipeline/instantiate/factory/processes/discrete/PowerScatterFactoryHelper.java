...
public class PowerScatterFactoryHelper {
    ...
    public PowerScatter build(BaseProcessArguments arguments, CellProcessArguments cpArguments, CellDescriptor cellDescriptor, ScatterClustersHelper clustersHelper) {
