...
public class CheckForExtinctionFactory implements Factory<CheckForExtinction> {

    private final CheckForExtinctionFactoryHelper helper;
    ...
    public CheckForExtinctionFactory(CheckForExtinctionFactoryHelper helper) {
        this.helper = helper;
    }
    ...
    @Override
    public CheckForExtinction build() {
        return helper.build(arguments, cpArguments, thresholdArg);
    }
}