...
public class ScheduleHoldFactoryHelper {

    public ScheduleHold build(BaseProcessArguments arguments, ContinuumLayerScheduler scheduler) {
        return new ScheduleHold(arguments, scheduler);
    }
}