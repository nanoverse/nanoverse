...
public class IntegrateFactory implements Factory<Integrate> {

    private final IntegrateFactoryHelper helper;

    private BaseProcessArguments arguments;
    private ContinuumLayerScheduler scheduler;

    public IntegrateFactory() {
        helper = new IntegrateFactoryHelper();
    }

    public IntegrateFactory(IntegrateFactoryHelper helper) {
        this.helper = helper;
    }
