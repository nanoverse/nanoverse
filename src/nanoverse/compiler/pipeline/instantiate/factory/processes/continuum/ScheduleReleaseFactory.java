...
public class ScheduleReleaseFactory implements Factory<ScheduleRelease> {
    ...
    private final ScheduleReleaseFactoryHelper helper;

    private BaseProcessArguments arguments;
    private ContinuumLayerScheduler scheduler;

    public ScheduleReleaseFactory() {
        helper = new ScheduleReleaseFactoryHelper();
    }

    public ScheduleReleaseFactory(ScheduleReleaseFactoryHelper helper) {
        this.helper = helper;
    }
