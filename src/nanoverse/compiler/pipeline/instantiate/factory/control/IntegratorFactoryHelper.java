...
public class IntegratorFactoryHelper {
    ...
    public Integrator build(GeneralParameters p, ProcessManager processManager, SerializationManager serializationManager) {
        return new Integrator(p, processManager, serializationManager);
    }
}