...
public class ExpandRandomFactory implements Factory<ExpandRandomDescriptor> {

    private final ExpandRandomFactoryHelper helper;
    ...
    public ExpandRandomFactory() {
        helper = new ExpandRandomFactoryHelper();
    }

    public ExpandRandomFactory(ExpandRandomFactoryHelper helper) {
        this.helper = helper;
    }
    ...
    @Override
    public ExpandRandomDescriptor build() {
