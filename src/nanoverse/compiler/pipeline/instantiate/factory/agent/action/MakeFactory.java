...
public class MakeFactory implements Factory<MakeDescriptor> {

    private final MakeFactoryHelper helper;
    ...
    public MakeFactory() {
        helper = new MakeFactoryHelper();
    }

    public MakeFactory(MakeFactoryHelper helper) {
        this.helper = helper;
    }
