...
public class NanosyntaxParser extends Parser {
    ...
    public static class StatementContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NanosyntaxVisitor)
                return ((NanosyntaxVisitor<? extends T>) visitor).visitStatement(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AssignmentContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NanosyntaxVisitor)
                return ((NanosyntaxVisitor<? extends T>) visitor).visitAssignment(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BlockContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NanosyntaxVisitor)
                return ((NanosyntaxVisitor<? extends T>) visitor).visitBlock(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SingletonContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NanosyntaxVisitor)
                return ((NanosyntaxVisitor<? extends T>) visitor).visitSingleton(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class IdContext extends ParserRuleContext {
        ...
        public TerminalNode ID() {
            return getToken(NanosyntaxParser.ID, 0);
        }
    ...
    public static class PrimitiveContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NanosyntaxVisitor)
                return ((NanosyntaxVisitor<? extends T>) visitor).visitPrimitive(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class StringPrimitiveContext extends ParserRuleContext {
        ...
        public TerminalNode STRING() {
            return getToken(NanosyntaxParser.STRING, 0);
        }

        @Override
        public int getRuleIndex() {
            return RULE_stringPrimitive;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NanosyntaxVisitor)
                return ((NanosyntaxVisitor<? extends T>) visitor).visitStringPrimitive(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FloatPrimitiveContext extends ParserRuleContext {
        ...
        public TerminalNode FLOAT() {
            return getToken(NanosyntaxParser.FLOAT, 0);
        }

        @Override
        public int getRuleIndex() {
            return RULE_floatPrimitive;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NanosyntaxVisitor)
                return ((NanosyntaxVisitor<? extends T>) visitor).visitFloatPrimitive(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class IntPrimitiveContext extends ParserRuleContext {
        ...
        public TerminalNode INTEGER() {
            return getToken(NanosyntaxParser.INTEGER, 0);
        }

        @Override
        public int getRuleIndex() {
            return RULE_intPrimitive;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NanosyntaxVisitor)
                return ((NanosyntaxVisitor<? extends T>) visitor).visitIntPrimitive(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BoolPrimitiveContext extends ParserRuleContext {
        ...
        public TerminalNode BOOLEAN() {
            return getToken(NanosyntaxParser.BOOLEAN, 0);
        }

        @Override
        public int getRuleIndex() {
            return RULE_boolPrimitive;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof NanosyntaxVisitor)
                return ((NanosyntaxVisitor<? extends T>) visitor).visitBoolPrimitive(this);
            else return visitor.visitChildren(this);
        }
    }
}