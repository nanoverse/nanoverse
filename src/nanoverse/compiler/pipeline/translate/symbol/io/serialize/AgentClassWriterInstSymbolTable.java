...
import nanoverse.compiler.pipeline.instantiate.loader.io.serialize.text.AgentClassWriterLoader;
 ...
 */
public class AgentClassWriterInstSymbolTable extends MapSymbolTable<LegacyAgentClassWriter> {
    @Override
    ...
    public Loader getLoader() {
        return new AgentClassWriterLoader();
    }
}
