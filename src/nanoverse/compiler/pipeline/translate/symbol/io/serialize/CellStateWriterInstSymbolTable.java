...
import nanoverse.compiler.pipeline.instantiate.loader.io.serialize.text.CellStateWriterLoader;
 ...
 */
public class CellStateWriterInstSymbolTable extends MapSymbolTable<LegacyCellStateWriter> {
    @Override
