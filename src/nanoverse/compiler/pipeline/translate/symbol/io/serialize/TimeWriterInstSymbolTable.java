...
import nanoverse.compiler.pipeline.instantiate.loader.io.serialize.binary.TimeWriterLoader;
 ...
 */
public class TimeWriterInstSymbolTable extends MapSymbolTable<TimeWriter> {
    @Override
