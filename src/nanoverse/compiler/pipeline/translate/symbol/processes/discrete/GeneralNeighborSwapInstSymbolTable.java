...
import nanoverse.compiler.pipeline.instantiate.loader.processes.discrete.GeneralNeighborSwapLoader;
...
public class GeneralNeighborSwapInstSymbolTable extends DiscreteProcessInstSymbolTable<GeneralNeighborSwap> {
    ...
    public String getDescription() {
        return "Swap the specified nanoverse.runtime.agent with any of its neighbors.";
    }
