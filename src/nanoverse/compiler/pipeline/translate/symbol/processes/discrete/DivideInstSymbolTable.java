...
import nanoverse.compiler.pipeline.instantiate.loader.processes.discrete.DivideLoader;
...
public class DivideInstSymbolTable extends DiscreteProcessInstSymbolTable<Divide> {
    ...
    public String getDescription() {
        return "LEGACY: Divide the nanoverse.runtime.agent to a neighboring site.";
    }
