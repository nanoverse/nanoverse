...
import nanoverse.compiler.pipeline.instantiate.loader.geometry.lattice.CubicLatticeLoader;
 ...
 */
public class CubicLatticeInstSymbolTable extends MapSymbolTable<CubicLattice> {
    @Override
