...
import nanoverse.compiler.pipeline.instantiate.loader.agent.targets.TargetSelfLoader;
...
public class TargetSelfInstSymbolTable extends TargetRuleInstSymbolTable<TargetSelfDescriptor> {
    ...
    public String getDescription() {
        return "Target the focal nanoverse.runtime.agent (i.e., the nanoverse.runtime.agent performing the action).";
    }
