...
public class Trigger extends Action {
     ...
     */
    public Trigger(BehaviorAgent callback, LayerManager layerManager, String behaviorName, TargetRule targetRule, IntegerArgument selfChannel, IntegerArgument targetChannel) {
    ...
    public void run(Coordinate caller) throws HaltCondition {
        ...
        for (Coordinate target : targets) {
            ...
            BehaviorAgent targetAgent = getWithCast(target);
            if (targetAgent == null) {
                continue;
            }
