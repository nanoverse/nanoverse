...
public class Flags {
    ...
    // If "planar" is set, nanoverse.runtime.geometry is 2D; otherwise it is 3D.
    ...
    // If "triangular" is set, nanoverse.runtime.geometry is triangular; otherwise it is rectangular.
