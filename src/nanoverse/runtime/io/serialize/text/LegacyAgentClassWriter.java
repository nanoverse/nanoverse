 ...
 */
@Deprecated
public class LegacyAgentClassWriter extends Serializer {
    public LegacyAgentClassWriter(GeneralParameters p, LayerManager lm) {
        super(p, lm);
    }

    @Override
    public void dispatchHalt(HaltCondition ex) {
        throw new NotYetImplementedException("Replace me with a binary writer based on names.");
    }
...
//
//    //public AgentClassWriter(String stateDir, Parameters p, int n) {
//
//    @FactoryTarget(displayName = "AgentClassWriter")
//    public LegacyAgentClassWriter(GeneralParameters p, LayerManager lm) {
//        super(p, lm);
//    }
//
...
//        int[] s = layer.getViewer().getNames();
...
//     */
//    private void writeDoubleArray(double[] v, AgentLayer layer, Extrema extrema,
