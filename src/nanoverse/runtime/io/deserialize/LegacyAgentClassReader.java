...
@Deprecated
public class LegacyAgentClassReader {
    public LegacyAgentClassReader(String fileRoot, CoordinateDeindexer deindexer) {
        throw new NotYetImplementedException("Replace me with something that matches the name-based writer");
    }
...
//
//    // The AgentClassReader always reads one line past the current state, so
...
//    // replicate project. The AgentClassReader is currently agnostic to that fact,
//    // so we just pass in a path.
//    private String path;
//
//    public LegacyAgentClassReader(String path, Geometry geom) {
//        this.path = path;
//
...
//    }
//
//    public LegacyAgentClassReader(String path, CoordinateDeindexer deindexer) {
...
//        String[] stateVector = viewer.getStateVector();
//        state.initAgentLayer(stateVector);
//    }
//
