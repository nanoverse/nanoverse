...
import compiler.pipeline.instantiate.loader.processes.discrete.filter.CellStateFilterLoader;
...
public class CellStateFilterInstSymbolTable extends MapSymbolTable<CellStateFilter> {
    ...
    private void state(HashMap<String, MemberSymbol> ret) {
        ...
        MemberSymbol ms = new MemberSymbol(rst, "The agent state/class to which the process should be restricted.");
        ret.put("state", ms);
    }
}
