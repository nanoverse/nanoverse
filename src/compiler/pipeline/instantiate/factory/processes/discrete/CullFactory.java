...
public class CullFactory implements Factory<Cull> {
    ...
    public CullFactory() {
        helper = new CullFactoryHelper();
    }

    public CullFactory(CullFactoryHelper helper) {
        this.helper = helper;
    }
    ...
    @Override
    public Cull build() {
        return helper.build(arguments, cpArguments, threshold);
    }
}