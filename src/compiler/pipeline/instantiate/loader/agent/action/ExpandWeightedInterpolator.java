 ...
 */
public class ExpandWeightedInterpolator {
    private final LoadHelper load;
    private final ExpandWeightedDefaults defaults;

    public ExpandWeightedInterpolator() {
        load = new LoadHelper();
        defaults = new ExpandWeightedDefaults();
    }

    public ExpandWeightedInterpolator(LoadHelper load, ExpandWeightedDefaults defaults) {
        this.load = load;
