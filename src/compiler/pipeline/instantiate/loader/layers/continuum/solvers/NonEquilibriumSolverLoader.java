...
import compiler.pipeline.instantiate.factory.layers.continuum.solvers.*;
...
public class NonEquilibriumSolverLoader extends ContinuumSolverLoader<NonEquilibriumSolver> {
    ...
    private final NonEquilibriumSolverFactory factory;

    public NonEquilibriumSolverLoader() {
        factory = new NonEquilibriumSolverFactory();
    }

    public NonEquilibriumSolverLoader(NonEquilibriumSolverFactory factory) {
