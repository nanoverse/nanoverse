...
public class MakeTest extends ActionTest {
    ...
    public void before() throws Exception {
        ...
        query = new Make(identity, mapper, highlighter, displacementManager, descriptor, stHighlighter, random);
    }
    ...
    public void lifeCycle() throws Exception {
        ...
        when(descriptor.next()).thenReturn(child);
        query.run(caller);
