...
public class NeighborhoodProbabilitySupplierInterpolatorTest
    extends InterpolatorTest {

    private NeighborhoodProbabilitySupplierInterpolator query;

    @Before
    public void before() throws Exception {
        super.before();
        query = new NeighborhoodProbabilitySupplierInterpolator(load);
    }
