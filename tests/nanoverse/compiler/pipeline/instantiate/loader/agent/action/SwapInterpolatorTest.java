...
public class SwapInterpolatorTest extends InterpolatorTest {

    private SwapDefaults defaults;
    private SwapInterpolator query;

    @Before
    public void before() throws Exception {
        super.before();
        defaults = mock(SwapDefaults.class);
        query = new SwapInterpolator(load, defaults);
    }
