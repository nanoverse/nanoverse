...
public class ApplyRelationshipsInterpolatorTest extends InterpolatorTest {

    private ApplyRelationshipsInterpolator query;

    @Before
    public void before() throws Exception {
        super.before();
        query = new ApplyRelationshipsInterpolator(load, null);
    }
