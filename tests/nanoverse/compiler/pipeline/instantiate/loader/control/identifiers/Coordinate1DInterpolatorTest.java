...
public class Coordinate1DInterpolatorTest extends InterpolatorTest {

    private Coordinate1DDefaults defaults;
    private Coordinate1DInterpolator query;

    @Before
    public void before() throws Exception {
        super.before();
        defaults = mock(Coordinate1DDefaults.class);
        query = new Coordinate1DInterpolator(load, defaults);
    }
