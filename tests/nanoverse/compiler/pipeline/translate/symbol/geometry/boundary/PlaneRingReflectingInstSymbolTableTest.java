...
public class PlaneRingReflectingInstSymbolTableTest extends MapSymbolTableTest {

    @Override
    protected MapSymbolTable getQuery() {
        return new PlaneRingReflectingInstSymbolTable();
    }

    @Override
    protected Class getExpectedClass() {
        return PlaneRingReflecting.class;
    }
}