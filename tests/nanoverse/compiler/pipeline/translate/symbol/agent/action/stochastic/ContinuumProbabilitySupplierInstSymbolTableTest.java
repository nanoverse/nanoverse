...
public class ContinuumProbabilitySupplierInstSymbolTableTest extends MapSymbolTableTest {

    @Override
    protected MapSymbolTable getQuery() {
        return new ContinuumProbabilitySupplierInstSymbolTable();
    }

    @Override
    protected Class getExpectedClass() {
        return ContinuumProbabilitySupplierDescriptor.class;
    }
