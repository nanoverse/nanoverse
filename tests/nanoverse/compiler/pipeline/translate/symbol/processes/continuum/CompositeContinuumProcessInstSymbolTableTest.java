...
public class CompositeContinuumProcessInstSymbolTableTest extends ProcessInstSymbolTableTest {

    @Override
    protected MapSymbolTable getQuery() {
        return new CompositeContinuumProcessInstSymbolTable();
    }

    @Override
    protected Class getExpectedClass() {
        return CompositeContinuumProcess.class;
    }
    ...
    public void children() throws Exception {
        verifyReturnSymbol("children", NanoverseProcess.class);
    }
}