...
import nanoverse.compiler.pipeline.interpret.nanosyntax.NanosyntaxParser.IntPrimitiveContext;
...
public class NanoPrimitiveIntegerVisitorTest extends TestBase {

    private NanoPrimitiveIntegerVisitor query;
    ...
    public void before() throws Exception {
        ...
        query = new NanoPrimitiveIntegerVisitor();
    }
    ...
    public void visitIntPrimitive() throws Exception {
        ...
        ASTNode output = query.visitIntPrimitive(ctx);
        verifyOutput(output);
    }
    ...
    private void verifyIdentifier(ASTNode output) {
        String expected = NanoPrimitiveIntegerVisitor.IDENTIFIER;
