...
public class TriggerActionInterpolatorTest extends InterpolatorTest {
    ...
    private TriggerActionDefaults defaults;
    private TriggerActionInterpolator query;

    @Before
    public void before() throws Exception {
        super.before();
        defaults = mock(TriggerActionDefaults.class);
        query = new TriggerActionInterpolator(load, defaults);
    }
