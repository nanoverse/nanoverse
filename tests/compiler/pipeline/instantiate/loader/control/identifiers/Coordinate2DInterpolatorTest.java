...
public class Coordinate2DInterpolatorTest extends InterpolatorTest {

    private Coordinate2DDefaults defaults;
    private Coordinate2DInterpolator query;

    @Before
    public void before() throws Exception {
        super.before();
        defaults = mock(Coordinate2DDefaults.class);
        query = new Coordinate2DInterpolator(load, defaults);
    }
